...
module.exports.changePasswordPatch = async (req, res) => {
    try {
        // Lấy id của tài khoản đang đăng nhập thông qua req.account
        // req.account là middleware đã được xác thực trước đó
        const id = req.account.id;
    
        // Cập nhật trường updatedBy với id của tài khoản đang đăng nhập
